...
- [**PWA-Workbox**](https://github.com/souldanger/jekyll-pwa-workbox) ★1 (gem: [jekyll-pwa-workbox](https://rubygems.org/gems/jekyll-pwa-workbox)) -- Makes your PWA/Website available offline, uses a Workbox service-worker, injects a precache list and takes care of the registration process in a secure way.
